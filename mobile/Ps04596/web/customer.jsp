                ...
                <div id="templatemo_header" class="header_subpage">
                    ...
                    <div id="templatemo_menu" class="ddsmoothmenu">
                        <ul>
                            ...
                            <li><a href="customer.jsp" class="selected">Customer</a></li>
                ...
                <div id="templatemo_main">
                    ...
                    <div id="content" class="right">
                        ...
                        <table border="1">
                            ...
                            <%
                                Customers1 listSP = new Customers1();
                                List<Customer> list = listSP.showCustomer("");
                                for (Customer c : list) {
                                    out.print("<form action=\"ControllerCustomers\">");
                                    out.print("<tr><td>" + c.getUsername() + "</td><td>" + c.getPassword() + "</td><td>" + c.getHoten() + "</td>"
                                            + "<td><input type=\"submit\" name=\"action\" value=\"Delete\"/></td>"
                                            + "<input type=\"hidden\" name=\"txtUser\" value='" + c.getUsername() + "'>"
                                            + "<input type=\"hidden\" name=\"txtPass\" value='" + c.getPassword() + "'>"
                                            + "<input type=\"hidden\" name=\"txtHoten\" value='" + c.getHoten() + "'></tr>");
                                    out.print("</form>");
                                }
                            %>
                        </table>
